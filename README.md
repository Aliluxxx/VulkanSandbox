...
The script will check if you have [CMake](https://cmake.org/download/) and the required [Vulkan SDK (1.4.335.0)](https://vulkan.lunarg.com/sdk/home) version installed. If not, it will automatically install them (on operating systems, the process may require manual installation).
